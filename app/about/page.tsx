...
export default function AboutPage() {
  return (
    <main className="bg-white text-stone-900 font-anodina text-base leading-relaxed">
      ...
      {/* Hero Title Section */}
      <section className="text-center px-6 sm:px-10 md:px-20 pt-28 pb-12">
        <FadeIn yOffset={30}>
      ...
      {/* Main Story Section */}
      <section className="py-20 px-6 sm:px-10 md:px-20 max-w-7xl mx-auto space-y-24">
        
        {/* Block 1 */}
        <FadeIn yOffset={30}>
          <div className="grid md:grid-cols-2 gap-12 font-regular text-[15px] items-center">
            <div>
              <p className="mb-5">
      ...
      {/* Statement Section */}
      <section className="px-6 sm:px-10 md:px-20 text-center py-10 border-y border-neutral-200 bg-[#fdfdfd]">
        <FadeIn yOffset={30}>
          <blockquote className="max-w-3xl mx-auto text-[18px] font-light leading-8 sm:leading-9 italic">
        ...
        {/* Block 2 */}
        <FadeIn yOffset={30}>
          <div className="grid md:grid-cols-2 gap-12 text-[15px] items-center md:flex-row-reverse">
            <img
      ...
      {/* Outro Content */}
      <section className="py-28 px-6 sm:px-10 md:px-20 max-w-4xl mx-auto space-y-6 text-[15px] leading-8">
        <FadeIn yOffset={30}>
          <p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-6">
            <p className="font-semibold text-[18px]">Let&rsquo;s start!</p>
            <Link
              href="/products"
